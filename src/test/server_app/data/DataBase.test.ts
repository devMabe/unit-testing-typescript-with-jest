...
type someTipeWithId = { id: string; name: string; color: string };

describe('Database test suite', () => {
  let sut: DataBase<someTipeWithId>;
  ...
  beforeEach(() => {
    sut = new DataBase<someTipeWithId>();
  ...
  it('should find all element with the same element', async () => {
